public class RedBlackTree
{
    ...
    private void printTreeInOrderWithColorsHelper(Node node) {
        if (node != null) {
            printTreeInOrderWithColorsHelper(node.left);

            System.out.printf("%d %s, ", node.data, (node.colour == 'R' ? "Red" : "Black"));
            printTreeInOrderWithColorsHelper(node.right);
        }
    }

    public void printTreeInOrderWithColors() {
        System.out.println("\n");
        printTreeInOrderWithColorsHelper(this.root);
    }
}